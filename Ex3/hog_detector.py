...
hitThreshold = 0.0
GREEN = (0, 255, 0)
detection_rectangle_thickness = 2
##--your-code-ends-here--##
...
while cv2.waitKey(delay) != ord('q'):
    try:
        ...
        ##--your-code-start-here--##
        for (x_coor, y_coor, width, height) in detections:
            cv2.rectangle(img, (x_coor, y_coor), (x_coor+width, y_coor+height), GREEN, detection_rectangle_thickness)
        ##--your-code-ends-here--##
