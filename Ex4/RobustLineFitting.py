...
while N > sample_count:
    ...
    point1 = points_h[:, id1]
    point2 = points_h[:, id2]
    cross_product = np.cross(point1, point2)
    l = cross_product/np.sqrt(cross_product[0]**2 + cross_product[1]**2)
    ##-your-code-ends-here-##
    ...
    ##-your-code-starts-here-##
    distance = np.abs(np.dot(cross_product, points_h))
    inliers = np.where(distance < t)[0]
    ##-your-code-ends-here-##
...
##-your-code-starts-here-##
final_distance = np.abs(np.dot(best_line, points_h))
inliers = np.where(final_distance < t)[0]
x_inliers = x[inliers]
y_inliers=y[inliers]
##-your-code-ends-here-##
